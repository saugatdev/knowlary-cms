...
export interface User {
  ...
  /**
   * Short author description for blog posts and JSON-LD
   */
  bio?: string | null;
  socialLinks?:
    | {
...
export interface Horoscope {
  ...
  sign:
    ...
    | 'pisces';
  /**
   * Optional title for the horoscope entry
   */
  title?: string | null;
  /**
   * For daily horoscopes, the specific date. Optional for monthly/yearly.
   */
  date?: string | null;
  /**
   * Start date for weekly horoscopes only
   */
  startDate?: string | null;
  /**
   * End date for weekly horoscopes only
   */
  endDate?: string | null;
  /**
  ...
  introLetter: string;
  /**
   * Full horoscope content for this type/sign/date
   */
  description: string;
  /**
   * Optional: Lucky numbers for the sign
   */
  luckyNumbers?: string | null;
  /**
   * Optional: Lucky color for the sign
   */
  color?: string | null;
  /**
   * Optional astrologer/author for this horoscope
   */
